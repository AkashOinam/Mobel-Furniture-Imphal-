        ...
        <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4 pt-2">
              <a href="https://www.facebook.com/MobelFurnitureImphal" className="text-slate-400 hover:text-brand-red transition-colors" aria-label="Facebook">
              ...
              <a href="https://www.instagram.com/mobelfurnitureimphal/" className="text-slate-400 hover:text-brand-red transition-colors" aria-label="Instagram">
              ...
              <a href="https://www.linkedin.com" className="text-slate-400 hover:text-brand-red transition-colors" aria-label="LinkedIn" target="_blank" rel="noopener noreferrer">
